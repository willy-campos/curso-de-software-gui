...
class GUI(QMainWindow):                 # inherit from QMainWindow
    ...
    def add_widgets(self):        
        ...
        file_menu = menubar.addMenu('Archivo')     # add menu to menu bar
          
        new_action = QAction('Nuevo', self)       # create an Action      
        file_menu.addAction(new_action)         # add Action to menu
          
        new_action.setStatusTip('Nuevo Archivo')     # statusBar updated 
